...
},{"../../modules/$":12,"../../modules/es6.object.assign":13}],7:[function(require,module,exports){
var $ = require('../../modules/$');
module.exports = function defineProperty(it, key, desc){
  return $.setDesc(it, key, desc);
};
},{"../../modules/$":12}],8:[function(require,module,exports){
var $        = require('./$')
...
},{"./$":12,"./$.enum-keys":10}],9:[function(require,module,exports){
var $          = require('./$')
  , global     = $.g
  , core       = $.core
...
module.exports = $def;
},{"./$":12}],10:[function(require,module,exports){
var $ = require('./$');
...
},{"./$":12}],11:[function(require,module,exports){
...
},{"./$.fw":11}],13:[function(require,module,exports){
// 19.1.3.1 Object.assign(target, source)
var $def = require('./$.def');
$def($def.S, 'Object', {assign: require('./$.assign')});
},{"./$.assign":8,"./$.def":9}],14:[function(require,module,exports){
...
},{"min-document":14}],23:[function(require,module,exports){
"use strict";
...
var Formell = (function () {
	_createClass(Formell, [{
		...
		get: function get() {
			return {
				...
				formH: _virtualDomH2['default']('form', {})
			};
		}
	}]);
	...
	function Formell(options) {
		...
		this.options = _Object$assign(this.options, options, this.defaults);
...
},{"babel-runtime/core-js/object/assign":1,"babel-runtime/helpers/class-call-check":3,"babel-runtime/helpers/create-class":4,"babel-runtime/helpers/interop-require-default":5,"virtual-dom/create-element":15,"virtual-dom/diff":16,"virtual-dom/h":17,"virtual-dom/patch":25}]},{},[48]);
