...
import Exoskeleton from '../../../../src/libs/helpers/exoskelesston';
import FormellSchema from '../../../../src/libs/formell-schema';

var expect = chai.expect;
var asset = chai.assert;
chai.should();

describe('Formell.Schema', function() {

    var SchemaFactory = new FormellSchema.Factory(),
        SchemaModel = FormellSchema.Model,
        SchemaCollection = FormellSchema.Collection,
        SchemaValueCollection = FormellSchema.ValueCollection,
        SchemaTestHelper = FormellSchema.TestHelper;

    var registerSchemas = function() {
            // Register some test schemas:
            SchemaFactory.register({
                "id": "/exoskeleton.schema/tests/person",
                "title": "Person",
                "type": "object",
                "properties": {
                    "id": {
                    ...
                    "address": {
                        "$ref": "/exoskeleton.schema/tests/address#"
                    },
                    "homePhoneNumber": {
                        "$ref": "/exoskeleton.schema/tests/phone-number#"
                    },
                    "mobilePhoneNumber": {
                        "$ref": "/exoskeleton.schema/tests/phone-number#"
                    },
            ...
            SchemaFactory.register({
                "id": "/exoskeleton.schema/tests/companies",
                "title": "Companies",
                "type": "array",
                "items": {
                    "$ref": "/exoskeleton.schema/tests/company#"
                }
            ...
            SchemaFactory.register({
                "id": "/exoskeleton.schema/tests/company",
                "title": "Company",
                "type": "object",
                "properties": {
                    "name": {
                    ...
                    "address": {
                        "extends": "/exoskeleton.schema/tests/address#",
                        "required": true
                    },
                    "phoneNumbers": {
                        "$ref": "/exoskeleton.schema/tests/phone-numbers#"
                    },
                    "employees": {
                        "type": "array",
                        "items": {
                            "$ref": "/exoskeleton.schema/tests/employee#"
                        }
                    }
                }
            });
            ...
            SchemaFactory.register({
                "id": "/exoskeleton.schema/tests/employee",
                "title": "Employee",
                "type": "object",
                "extends": {
                    "$ref": "/exoskeleton.schema/tests/person#"
                },
                "properties": {
                    "joinDate": {
                        "type": "date",
            ...
            SchemaFactory.register({
                "id": "/exoskeleton.schema/tests/address",
                "title": "Address",
                "type": "object",
                "properties": {
                    "streetNumber": {
            ...
            SchemaFactory.register({
                "id": "/exoskeleton.schema/tests/phone-numbers",
                "title": "Phone Numbers",
                "type": "array",
                "items": {
                    "$ref": "/exoskeleton.schema/tests/phone-number#"
            ...
            SchemaFactory.register({
                "id": "/exoskeleton.schema/tests/phone-number",
                "title": "Phone Number",
                "type": "object",
                "properties": {
                    "countryCode": {
            ...
            SchemaFactory.register({
                "id": "/exoskeleton.schema/tests/validation/required",
            ...
            SchemaFactory.register({
                "id": "/exoskeleton.schema/tests/validation/maxLength",
            ...
            SchemaFactory.register({
                "id": "/exoskeleton.schema/tests/validation/minLength",
    ...
    var validationTestSchema = {
        "id": "/exoskeleton.schema/tests/validation/",
        "title": "Validation",
        "properties": {}
    };
    ...
    var ModelValidationTester = function(property, initialValue) {
            ...
            var schema = Object.assign({}, validationTestSchema);
    ...
    describe('SchemaFactory', function() {
        ...
        it('should be able to retrieve a registered schema', function() {
            var schemaId = "/tests/Exoskeleton.Schema/SchemaFactory/should be able to retrieve a registered schema";
        ...
        it('should create a custom model', function() {
            ...
            assert.instanceOf(testModel, Exoskeleton.Model);
    ...
    describe('SchemaModel', function() {
                ...
                var schemaA = {
                    ...
                    "properties": {
                        "aa": {
                            ...
                            "properties": {
                                "aaa": {
                                    "$ref": "/exoskeleton.schema/tests/b#/properties/bb"
                                }
                            }
                        }
                    }
                ...
                var schemaB = {
                    ...
                    "properties": {
                        "bb": {
                            ...
                            "properties": {
                                "bbb": {
                                    "$ref": "/exoskeleton.schema/tests/a#/properties/aa"
                                }
                            }
                        }
                    }
        ...
        describe('toJSON', function() {
            ...
            it('should serialize a circular reference (with ids)', function() {
                var schemaA = {
                    ...
                    "properties": {
                        ...
                        "b": {
                            "$ref": "/exoskeleton.schema/tests/b#"
                        }
                    }
                };
                ...
                var schemaB = {
                    ...
                    "properties": {
                        ...
                        "a": {
                            "$ref": "/exoskeleton.schema/tests/a#"
                        }
                    }
                };
            ...
            it('should serialize a circular reference (with custom ids)', function() {
                ...
                var ModelA = SchemaFactory.create("/exoskeleton.schema/tests/a");
                var ModelB = SchemaFactory.create("/exoskeleton.schema/tests/b");
                ...
                assert.instanceOf(modelA, Exoskeleton.Model);
    ...
    describe('SchemaCollection', function() {
        ...
        describe('Initialization', function() {
            ...
            it('should add an uninitialized schema model to a collection', function() {
                var Company = SchemaFactory.create("/exoskeleton.schema/tests/company");
    ...
    describe('__Internals__', function() {
        ...
        describe('Parse Schema', function() {
            ...
            describe('References', function() {
                ...
                it('"$ref": "#"', function() {
                    schema = {
                        "id": "/exoskeleton.schema/tests/test",
                        "type": "object",
                        "properties": {
                            "self": {
                                "$ref": "#"
                ...
                it('"$ref": "schemaid#"', function() {
                    var referenced = parse({
                        "id": "/exoskeleton.schema/tests/referenced",
                        "type": "object"
                    });
                    ...
                    var parsed = parse({
                        ...
                        "properties": {
                            "referenced": {
                                "$ref": "/exoskeleton.schema/tests/referenced#"
                            }
                        }
                    });
                ...
                it('"$ref": "schemaid#fragment"', function() {
                    ...
                    var parsed = parse({
                        ...
                        "properties": {
                            "reference": {
                                "$ref": "/exoskeleton.schema/tests/referenced#/properties/referenced"
                            }
                        }
                    });
                ...
                it('Circular "$ref": "schemaid#fragment"', function() {
                    ...
                    var schemaB = {
                        ...
                        "properties": {
                            "bb": {
                                "$ref": "/exoskeleton.schema/tests/b#/properties/aa"
                            }
                        }
                    };
            ...
            describe('Format', function() {
                ...
                describe('date-time', function() {
                    ...
                    it.skip('should return false when value is invalid date-time', function() {
                        ['200905', '2009367', '2009-', '2007-04-05T24:50', '2009-000', '2009-M511', '2009M511', '2009-05-19T14a39r', '2009-05-19T14:3924', '2009-0519', '2009-05-1914:39', '2009-05-19 14:', '2009-05-19r14:39', '2009-05-19 14a39a22', '200912-01', '2009-05-19 14:39:22+06a00', '2009-05-19 146922.500', '2010-02-18T16.5:23.35:48', '2010-02-18T16:23.35:48', '2010-02-18T16:23.35:48.45', '2009-05-19 14.5.44', '2010-02-18T16:23.33.600', '2010-02-18T16,25:23:48,444'].forEach(function(date) {
                ...
                describe('color', function() {
                    ...
                    it('should return true when value is valid color', function() {
                        ['#000000', '#FF0000', '#FFFFFF', 'red', 'green', 'bisque'].forEach(function(color) {
                    ...
                    it('should return false when value is invalid color', function() {
                        ['#F00', '#12345', '000', '123456', 'newyork'].forEach(function(color) {
                ...
                describe('uri', function() {
                    ...
                    it('should return true when value is valid uri', function() {
                        ['http://jargon.io', 'http://pix.ie', 'https://www.bt.co.uk:80'].forEach(function(uri) {
                    ...
                    it('should return false when value is invalid uri', function() {
                        ['www.tcd.ie', 'https://', '//redpie.com'].forEach(function(uri) {
